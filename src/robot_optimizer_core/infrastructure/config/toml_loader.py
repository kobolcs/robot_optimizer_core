# src/robot_optimizer_core/infrastructure/config/toml_loader.py
...
Usage::
    ...
    from robot_optimizer_core.infrastructure.config.toml_loader import load_settings_from_toml
